...
namespace CTaxCalculator.Framework.Endpoints.Web.Extensions.DI
{
    ...
    {
        public static IServiceCollection AddArkaSoftwareApplicationServices(this IServiceCollection services,
                                                                     IEnumerable<Assembly> assembliesForSearch)
            => services.AddCommandHandlers(assembliesForSearch)
                       .AddCommandDispatcherDecorators()
                        .AddSnowFlakeIdGenerator()
        ...
        private static IServiceCollection AddSnowFlakeIdGenerator(this IServiceCollection services)
        {
        ...
        private static IServiceCollection AddEventDispatcherDecorators(this IServiceCollection services)
        {
            ...
            services.AddTransient<IDomainEventDispatcher>(c =>
            {
